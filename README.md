...
- The database server is accessible through port `13306`.  Check the details in the `docker-compose.yml` file for configured `root` User and second user credentials.
